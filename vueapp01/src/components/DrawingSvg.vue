...
export default {
  ...
  data () {
    return {
      ...
      ptnList: [ {id: 'pattern1', src: 'pattern1.png', width: 150, height: 150, zoom: '30%'},
        {id: 'pattern2', src: 'pattern2.png', width: 30, height: 30, zoom: '30%'},
        {id: 'pattern3', src: 'pattern3.png', width: 50, height: 50, zoom: '20%'},
        {id: 'pattern4', src: 'pattern4.png', width: 100, height: 100, zoom: '30%'},
        {id: 'pattern5', src: 'pattern5.png', width: 400, height: 400, zoom: '100%'},
        {id: 'pattern6', src: 'pattern6.png', width: 800, height: 800, zoom: '117%'},
        {id: 'pattern7', src: 'pattern7.jpeg', width: 120, height: 50, zoom: '25%'}]
    }
  },
  mounted () {
    this.load()
