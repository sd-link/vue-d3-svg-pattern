<template>
  <div class="hello">
    ...
    <svg viewBox="0 0 1000 1000">
      ...
      <!-- patterned material -->
      <path v-for="item in objList" :key="item.id" :id="item.id" class="part" :fill="'url(#' + item.ptnId +')'" filter="url(#filter1)" :d="item.d"/>
    </svg>
  </div>
</template>
  ...
  data () {
    return {
      ...
      ptnList: [ {id: 'pattern1', src: 'pattern1.jpeg', width: 150, height: 150, zoom: '20%'},
        ...
        {id: 'pattern4', src: 'pattern4.jpeg', width: 150, height: 150, zoom: '20%'},
